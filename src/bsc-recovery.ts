...
export class BscRecovery extends Recovery {
    private readonly web3: Web3;
    private readonly ethereumJSCommon: Common;

    constructor(options: RecoveryOptions) {
        super(options, BlockchainType.BinanceSmartChain);
    ...
    public async recover(params: RecoverParams) {
        ...
        const symbol = params.tokenAddress ? totalValue.symbol : 'BNB';
        ...
        const transactionParams = {
            encodedData: this.walletContract.methods.transferBnb(params.recipientAddress, totalValue.amount).encodeABI(),
        ...
        console.log(`The fee to be charged is ${transactionResult.transactionFee} BNB, and it will be withdrawn from account '${this.getAccountKeyAddress()}'.`);
